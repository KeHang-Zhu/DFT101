...
def compute_energy(alat, clat, nk, ecut):
    ...
    dirname = "Fe_Mag_a_{}_ecut_{}_nk_{}".format(alat, ecut, nk)
...
def compute_energy_anti(alat, clat, nk, ecut):
    """
    Make an input template and select potential and structure, and the path where to run
    """
    potname = "Fe.pbe-nd-rrkjus.UPF"
...
#     print(output)
    output2 = compute_energy_anti(alat=alat, clat = clat, ecut=ecut, nk=nk)
    print(output2)
